...
for modelseed in "${modelseed_list[@]}"; do
    for actfunc in "${actfunc_list[@]}"; do
        ...
        CUDA_VISIBLE_DEVICES=7 python train.py --model RFMLP --data mnist --epochs 10 --M 1000 --modelseed $modelseed --actfunc $actfunc &
        CUDA_VISIBLE_DEVICES=6 python train.py --model RFMLP --data cifar10 --epochs 20 --M 3000 --modelseed $modelseed --actfunc $actfunc &
        CUDA_VISIBLE_DEVICES=5 python train.py --model RFMLP --data adult --epochs 15 --M 3000 --modelseed $modelseed --actfunc $actfunc &
        CUDA_VISIBLE_DEVICES=4 python train.py --model RFMLP --data protein --epochs 30 --M 3000 --modelseed $modelseed --actfunc $actfunc &

        wait

        CUDA_VISIBLE_DEVICES=7 python train.py --model RFMLP --data sin --epochs 45 --M 1000 --actfunc $actfunc --modelseed $modelseed &
        CUDA_VISIBLE_DEVICES=6 python train.py --model RFMLP --data tru --epochs 45 --M 1000 --actfunc $actfunc --modelseed $modelseed &
        CUDA_VISIBLE_DEVICES=5 python train.py --model RFMLP --data zoi --epochs 45 --M 1000 --actfunc $actfunc --modelseed $modelseed
